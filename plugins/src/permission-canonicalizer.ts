...
export const AUDIT_LOG_PATH = "/Users/hunter/.local/share/opencode/permission-audit-plugin/audit.log";
export const DEBUG_LOG_PATH = "/Users/hunter/.local/share/opencode/permission-audit-plugin/debug.log";
...
function parseOptions(options: unknown): { enabled: boolean; canonicalizeOptions: CanonicalizeOptions; auditLogPath: string; debugLogPath: string } {
  if (options === undefined) {
    return { enabled: true, canonicalizeOptions: {}, auditLogPath: AUDIT_LOG_PATH, debugLogPath: DEBUG_LOG_PATH };
  }
  if (typeof options !== "object" || options === null || Array.isArray(options)) {
    return { enabled: false, canonicalizeOptions: {}, auditLogPath: AUDIT_LOG_PATH, debugLogPath: DEBUG_LOG_PATH };
  }
  ...
  return {
    ...
    auditLogPath: typeof raw.auditLogPath === "string" ? raw.auditLogPath : AUDIT_LOG_PATH,
    debugLogPath: typeof raw.debugLogPath === "string" ? raw.debugLogPath : DEBUG_LOG_PATH,
  };
}

const PermissionCanonicalizerPlugin: Plugin = async (_ctx, options) => {
...
export default PermissionCanonicalizerPlugin;
